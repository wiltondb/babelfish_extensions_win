...
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalin);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimaltypmodin);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimaltypmodout);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalout);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalrecv);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalsend);

PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimaleq);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalne);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimallt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalgt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalle);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalge);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_cmp);

PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int2_eq);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int2_ne);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int2_lt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int2_gt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int2_le);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int2_ge);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int2_cmp);

PG_FUNCTION_INFO_V1_DLLEXPORT(int2_fixeddecimal_eq);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2_fixeddecimal_ne);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2_fixeddecimal_lt);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2_fixeddecimal_gt);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2_fixeddecimal_le);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2_fixeddecimal_ge);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2_fixeddecimal_cmp);

PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int4_eq);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int4_ne);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int4_lt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int4_gt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int4_le);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int4_ge);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int4_cmp);

PG_FUNCTION_INFO_V1_DLLEXPORT(int4_fixeddecimal_eq);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4_fixeddecimal_ne);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4_fixeddecimal_lt);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4_fixeddecimal_gt);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4_fixeddecimal_le);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4_fixeddecimal_ge);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4_fixeddecimal_cmp);


PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int8_eq);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int8_ne);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int8_lt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int8_gt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int8_le);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int8_ge);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_int8_cmp);

PG_FUNCTION_INFO_V1_DLLEXPORT(int8_fixeddecimal_eq);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8_fixeddecimal_ne);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8_fixeddecimal_lt);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8_fixeddecimal_gt);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8_fixeddecimal_le);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8_fixeddecimal_ge);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8_fixeddecimal_cmp);

PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_numeric_cmp);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_numeric_eq);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_numeric_ne);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_numeric_lt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_numeric_gt);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_numeric_le);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_numeric_ge);
PG_FUNCTION_INFO_V1_DLLEXPORT(numeric_fixeddecimal_cmp);
PG_FUNCTION_INFO_V1_DLLEXPORT(numeric_fixeddecimal_eq);
PG_FUNCTION_INFO_V1_DLLEXPORT(numeric_fixeddecimal_ne);
PG_FUNCTION_INFO_V1_DLLEXPORT(numeric_fixeddecimal_lt);
PG_FUNCTION_INFO_V1_DLLEXPORT(numeric_fixeddecimal_gt);
PG_FUNCTION_INFO_V1_DLLEXPORT(numeric_fixeddecimal_le);
PG_FUNCTION_INFO_V1_DLLEXPORT(numeric_fixeddecimal_ge);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_hash);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalum);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalup);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalpl);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalmi);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalmul);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimaldiv);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalabs);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimallarger);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalsmaller);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint8pl);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint8mi);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint8mul);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint8div);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8fixeddecimalpl);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8fixeddecimalmi);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8fixeddecimalmul);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8fixeddecimaldiv);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint4pl);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint4mi);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint4mul);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint4div);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4fixeddecimalpl);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4fixeddecimalmi);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4fixeddecimalmul);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4fixeddecimaldiv);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint2pl);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint2mi);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint2mul);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint2div);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2fixeddecimalpl);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2fixeddecimalmi);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2fixeddecimalmul);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2fixeddecimaldiv);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8fixeddecimal);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint8);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4fixeddecimal);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint4);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2fixeddecimal);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalint2);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimaltod);
PG_FUNCTION_INFO_V1_DLLEXPORT(dtofixeddecimal);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimaltof);
PG_FUNCTION_INFO_V1_DLLEXPORT(ftofixeddecimal);
PG_FUNCTION_INFO_V1_DLLEXPORT(numeric_fixeddecimal);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_numeric);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_avg_accum);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_avg);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimal_sum);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalaggstatecombine);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalaggstateserialize);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalaggstatedeserialize);

PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalaggstatein);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalaggstateout);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalaggstatesend);
PG_FUNCTION_INFO_V1_DLLEXPORT(fixeddecimalaggstaterecv);

PG_FUNCTION_INFO_V1_DLLEXPORT(char_to_fixeddecimal);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8_to_money);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8_to_smallmoney);
