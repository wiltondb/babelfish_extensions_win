...
PG_FUNCTION_INFO_V1_DLLEXPORT(trancount);
PG_FUNCTION_INFO_V1_DLLEXPORT(version);
PG_FUNCTION_INFO_V1_DLLEXPORT(error);
PG_FUNCTION_INFO_V1_DLLEXPORT(pgerror);
PG_FUNCTION_INFO_V1_DLLEXPORT(datalength);
PG_FUNCTION_INFO_V1_DLLEXPORT(int_floor);
PG_FUNCTION_INFO_V1_DLLEXPORT(int_ceiling);
PG_FUNCTION_INFO_V1_DLLEXPORT(bit_floor);
PG_FUNCTION_INFO_V1_DLLEXPORT(bit_ceiling);
PG_FUNCTION_INFO_V1_DLLEXPORT(servername);
PG_FUNCTION_INFO_V1_DLLEXPORT(servicename);
PG_FUNCTION_INFO_V1_DLLEXPORT(xact_state);
PG_FUNCTION_INFO_V1_DLLEXPORT(get_enr_list);
PG_FUNCTION_INFO_V1_DLLEXPORT(tsql_random);
PG_FUNCTION_INFO_V1_DLLEXPORT(is_member);
PG_FUNCTION_INFO_V1_DLLEXPORT(schema_id);
PG_FUNCTION_INFO_V1_DLLEXPORT(schema_name);
PG_FUNCTION_INFO_V1_DLLEXPORT(datefirst);
PG_FUNCTION_INFO_V1_DLLEXPORT(options);
PG_FUNCTION_INFO_V1_DLLEXPORT(default_domain);
PG_FUNCTION_INFO_V1_DLLEXPORT(tsql_exp);
PG_FUNCTION_INFO_V1_DLLEXPORT(host_os);
PG_FUNCTION_INFO_V1_DLLEXPORT(tsql_stat_get_activity_deprecated_in_2_2_0);
PG_FUNCTION_INFO_V1_DLLEXPORT(tsql_stat_get_activity);
PG_FUNCTION_INFO_V1_DLLEXPORT(get_current_full_xact_id);
PG_FUNCTION_INFO_V1_DLLEXPORT(checksum);
PG_FUNCTION_INFO_V1_DLLEXPORT(has_dbaccess);
PG_FUNCTION_INFO_V1_DLLEXPORT(sp_datatype_info_helper);
PG_FUNCTION_INFO_V1_DLLEXPORT(language);
PG_FUNCTION_INFO_V1_DLLEXPORT(host_name);
PG_FUNCTION_INFO_V1_DLLEXPORT(procid);
PG_FUNCTION_INFO_V1_DLLEXPORT(babelfish_integrity_checker);
