...
PG_FUNCTION_INFO_V1_DLLEXPORT(bitin);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitout);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitrecv);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitsend);
PG_FUNCTION_INFO_V1_DLLEXPORT(int2bit);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4bit);
PG_FUNCTION_INFO_V1_DLLEXPORT(int8bit);
PG_FUNCTION_INFO_V1_DLLEXPORT(numeric_bit);
PG_FUNCTION_INFO_V1_DLLEXPORT(ftobit);
PG_FUNCTION_INFO_V1_DLLEXPORT(dtobit);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitneg);
PG_FUNCTION_INFO_V1_DLLEXPORT(biteq);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitne);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitlt);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitle);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitgt);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitge);
PG_FUNCTION_INFO_V1_DLLEXPORT(bit_cmp);
PG_FUNCTION_INFO_V1_DLLEXPORT(bit2int2);
PG_FUNCTION_INFO_V1_DLLEXPORT(bit2int4);
PG_FUNCTION_INFO_V1_DLLEXPORT(bit2int8);
PG_FUNCTION_INFO_V1_DLLEXPORT(bit2numeric);
PG_FUNCTION_INFO_V1_DLLEXPORT(bit2fixeddec);
PG_FUNCTION_INFO_V1_DLLEXPORT(varchar2bit);

/* Comparison between int and bit */
PG_FUNCTION_INFO_V1_DLLEXPORT(int4biteq);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4bitne);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4bitlt);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4bitle);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4bitgt);
PG_FUNCTION_INFO_V1_DLLEXPORT(int4bitge);

/* Comparison between bit and int */
PG_FUNCTION_INFO_V1_DLLEXPORT(bitint4eq);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitint4ne);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitint4lt);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitint4le);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitint4gt);
PG_FUNCTION_INFO_V1_DLLEXPORT(bitint4ge);
